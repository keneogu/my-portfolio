      ...
      <div className="md:h-72 rounded-xl relative group">
        ...
        >
          <div className="overlay items-center z-10 justify-center absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500">
            <Link
              href={gitUrl}
              className="h-14 w-14 border-[#ADB7BE] hover:border-white hover:text-white flex items-center justify-center group/link"
            >
              <CodeIcon
                size={40}
                className="cursor-pointer group-hover/link:text-white"
              />
            </Link>
            <Link
              href={previewUrl}
              className="h-14 w-14 border-2 rounded-full border-[#ADB7BE] hover:border-white hover:text-white flex items-center justify-center group/link"
            >
              <EyeIcon
                size={40}
                className="cursor-pointer group-hover/link:text-white"
